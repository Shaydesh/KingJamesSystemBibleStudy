...
// 1 Corinthians 5:6-8 with Strong's references
const corinthians5_6: Verse = {
  verse: "6",
...
export const PurgeOutOldLeaven: React.FC = () => {
  return (
    <ScripturePassage
      book="I Corinthians"
      chapter={5}
      verses={[corinthians5_6, corinthians5_7, corinthians5_8]}
      displayReference="I Corinthians 5:6-8"
      linkToVerse={6}
    />
  );
};
